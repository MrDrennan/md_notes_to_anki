...
This is a fork of [Obsidian_to_Anki](https://github.com/ObsidianToAnki/Obsidian_to_Anki). I am mainly interested in making alterations to the command line script to suit my needs.
---
# Obsidian_to_Anki
